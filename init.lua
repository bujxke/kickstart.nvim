...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Server-specific overrides live in after/lsp/*.lua.
      local servers = {
        -- clangd,
        -- gopls,
        -- pyright,
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      vim.cmd.colorscheme 'ghostty_monokai_remastered'
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'yaml', 'typescript', 'tsx', 'javascript' },
